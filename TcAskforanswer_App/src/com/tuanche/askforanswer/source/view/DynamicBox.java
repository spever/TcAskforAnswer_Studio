...
public class DynamicBox {
    ...
    private final String[] mSupportedViews = new String[]{"linearlayout","relativelayout", "framelayout", "scrollview","pulltorefreshadapterviewbase"};
