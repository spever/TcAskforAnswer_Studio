...
//		System.loadLibrary("lashou_validators");
	...
	{	
		...
		String clientId = Session.get(MyApp.getmContext()).getDeviceid();
		if (TextUtils.isEmpty(clientId)) {
			clientId = STIDUtil.getDeviceId(MyApp.getmContext());
		}
	...
	public native static String decodeSafeSign(String txt);
	 ...
	 private final static char[] NUMCODE ="1234567890".toCharArray();
	 ...
	 public static  String generateRandom() {
	        ...
	        int count = rand.nextInt(10) + 5; // a random size from 5 to 14
	        for (int i = 0; i < count; i++) {
	            buffer.append(NUMCODE[rand.nextInt(NUMCODE.length)]);
	        }
	 ...
	 * @return
	 */
	public native static String getSafeKey(String randomNum);
