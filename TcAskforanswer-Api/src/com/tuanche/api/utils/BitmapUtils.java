...
import com.tuanche.api.bitmap.BitmapCacheListener;
...
import com.tuanche.api.bitmap.callback.SimpleBitmapLoadCallBack;
import com.tuanche.api.bitmap.core.BitmapSize;
import com.tuanche.api.bitmap.download.Downloader;
...
public class BitmapUtils {
    ...
    public BitmapUtils(Context context, String diskCachePath) {
        ...
        if(diskCachePath==null){
        	diskCachePath=AppUtils.getPath(context,StorageFile.cache);
        }
