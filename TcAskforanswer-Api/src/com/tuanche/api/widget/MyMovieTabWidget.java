...
import com.tuanche.api.exception.BaseException;
 ...
 * 
 */
public class MyMovieTabWidget extends LinearLayout {

	private static final String TAG = "MyMovieTabWidget";
	private int[] mDrawableIds = new int[] { R.drawable.ic_movie_tab_home,
			R.drawable.ic_movie_tab_cinema, R.drawable.ic_movie_tab_my,
			R.drawable.ic_movie_tab_more};
	...
	public MyMovieTabWidget(Context context, AttributeSet attrs) {
		super(context,attrs);

		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.TabWidget, 0, 0);
		...
		if (null == mLabels || mLabels.length <= 0) {
			try {
				...
				LogUtils.i(MyMovieTabWidget.class.getSimpleName() + " 出错");
			}
			a.recycle();
			return;
		}
	...
	@SuppressLint("NewApi")
	public MyMovieTabWidget(Context context, AttributeSet attrs, int defStyle) {
	...
	public MyMovieTabWidget(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(final Context context) {
		...
		this.setBackgroundResource(R.drawable.navigationbar_bg);
...
//				view.setBackgroundColor(Color.parseColor("#1E2122"));
			} else {
...
//				mViewList.get(i).setBackgroundColor(Color.parseColor("#1E2122"));
			} else {
