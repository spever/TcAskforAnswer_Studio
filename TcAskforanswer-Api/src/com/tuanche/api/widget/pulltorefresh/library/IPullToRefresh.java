...
import com.tuanche.api.widget.pulltorefresh.library.PullToRefreshBase.OnPullEventListener;
import com.tuanche.api.widget.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import com.tuanche.api.widget.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
import com.tuanche.api.widget.pulltorefresh.library.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
	 ...
	 * 
	 * @param 如果你想要过滤触摸事件返回true，默认返回true。
	 */
