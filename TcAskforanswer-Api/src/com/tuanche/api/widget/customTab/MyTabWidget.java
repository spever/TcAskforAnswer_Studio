package com.tuanche.api.widget.customTab;
	...
	private void init(final Context context) {
		...
		for (int i = 0; i < size; i++) {
			...
			itemName.setCompoundDrawablesWithIntrinsicBounds(null, context
					.getResources().getDrawable(ta.getResourceId(i, 0)), null, null);
...
//				view.setBackgroundColor(Color.rgb(240, 241, 242));
				...
				itemName.setTextColor(Color.rgb(253, 79, 10));
				view.setBackgroundColor(Color.rgb(250, 250, 250));
			} else {
				itemName.setChecked(false);
				itemName.setTextColor(Color.rgb(126, 135, 152));
				view.setBackgroundColor(Color.rgb(250, 250, 250));
			}
