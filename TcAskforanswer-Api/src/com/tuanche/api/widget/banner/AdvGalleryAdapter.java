...
import com.tuanche.api.widget.banner.AdsLooper.AdsEntity;
...
//	private DisplayImageOptions mOptions;
	...
	public AdvGalleryAdapter(Context context, List<AdsEntity> data,
		...
		if(bannerDefaultPic!=null){
			...
			config.setLoadingDrawable(mContext.getResources().getDrawable(R.drawable.default_banner_gallery));
			config.setLoadFailedDrawable(mContext.getResources().getDrawable(R.drawable.default_banner_gallery));
		}
...
//				.displayImage(data.get(index).getUri(), holder.iv, mOptions);
	...
	public void setData(List<AdsEntity> data){
		if (data!=null){
			...
			this.data=new ArrayList<AdsLooper.AdsEntity>();
		}
	}
}
