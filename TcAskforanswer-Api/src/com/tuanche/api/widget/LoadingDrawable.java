...
public class LoadingDrawable extends AnimationDrawable {
    ...
    public LoadingDrawable(Context context, int style, int highlightColor, int defaultColor, int duration) {
        ...
        case SIZE_SMALL:
            space = res.getDimension(R.dimen.api_space_small);
            halfWidth = space / 2;
            width = space;
            lightHalfWidth = res.getDimension(R.dimen.api_space_small_h) / 2;
            totalWidth = (int) res.getDimension(R.dimen.api_width_small);
            totalHeight = (int) res.getDimension(R.dimen.api_height_small);
            break;
        case SIZE_MEDIUM:
            space = res.getDimension(R.dimen.api_space_medium);
            halfWidth = space / 2;
            width = space;
            lightHalfWidth = res.getDimension(R.dimen.api_space_medium_h) / 2;
            totalWidth = (int) res.getDimension(R.dimen.api_width_medium);
            totalHeight =  (int) res.getDimension(R.dimen.api_height_medium);
            break;
        case SIZE_LARGE:
            space = res.getDimension(R.dimen.api_space_large);
            halfWidth = space / 2;
            width = space;
            lightHalfWidth = res.getDimension(R.dimen.api_space_large_h) / 2;
            totalWidth = (int) res.getDimension(R.dimen.api_width_large);
            totalHeight = (int) res.getDimension(R.dimen.api_height_large);
            break;
        }
